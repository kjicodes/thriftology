...
urlpatterns = [
    ...
    path('listings/<int:listing_id>/',
         views.listings_detail, name='listings_detail'),
    path('listings/create/', views.ListingCreate.as_view(), name='create'),
    path('listings/<int:listing_id>/buy_listing',
         views.buy_listing, name='buy_listing'),
    ...
    path('mythrifts/listings/<int:pk>/update/',
