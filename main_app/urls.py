...
urlpatterns = [
    ...
    path('listings/<int:listing_id>/buy_listing', views.buy_listing, name='buy_listing'),
    ...
    path('listings/<int:listing_id>/photo/<int:photo_id>', views.delete_photo, name='delete_photo'),
]
